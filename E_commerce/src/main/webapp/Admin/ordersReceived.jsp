...
<table id="customers">
        ...
        try
        {
          ...
          ResultSet rs=st.executeQuery("select * from cart inner join product where cart.product_id=product.id and cart.orderDate is not NULL and cart.stataus='processing'");
          while(rs.next())
          {
            ...
            <td><i class="fa fa-inr"></i><%=rs.getString(5) %>  </td>
             ...
             <td><%=rs.getString(11) %></td>
              <td><%=rs.getString(12) %></td>
               ...
               <td><a href="cancelOrders.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel <i class='fas fa-window-close'></i></a></td>
